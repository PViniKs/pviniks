...
### Sobre mim
Me chamo **Paulo Vinícius**, tenho 20 anos e sou estudante de Bacharelado em Sistemas de Informação, além de ter cursado 1 semestre em Engenharia de Redes e Sistemas de Computadores na ESTG (Instituto Politécnico de Viana do Castelo - Portugal).

### Tecnologias e Aprendizado
- 🌱 *Atualmente Estudando:* Java, Node.js, Cibersegurança
- 🔭 *Aprimorando:* Python, C++, MongoDB
- 💻 *Possuo conhecimento:* Python, Java, JavaScript, Node.js, C, C#, C++, PHP, HTML5, CSS, PostgreSQL, MySQl, MongoDB
...
- WP 3. EcoDispatch – Development of a New System for Shipment, Sequencing, and Ecological Transport

    └ Desenvolvido no contexto da Agenda Mobilizadora DRIVOLUTION – Transição para a Fábrica do Futuro

    └ [Edital](https://www.ipvc.pt/wp-content/uploads/2025/03/Edital_BII_01_2025_DRIVOLUTION-WP3-12-Bolsas_signed.pdf)
...
- Selecionado para um programa de **Mobilidade Estudantil Internacional** para Portugal (*14/02 a 19/07 de 2025*)
...
### Objetivos Futuros
Tenho interesse em trabalhar com programação, seja em desenvolvimento de jogos, engenharia de software ou em cibersegurança. Além disso, após ter morado por 1 semestre em Portugal, minha vontade de morar e trabalhar no exterior aumentou. Ainda possuo um sonho especial de conhecer a Áustria e a Itália.
...
### About Me
My name is **Paulo Vinícius**, I'm 20 years old and I'm a student of Bachelor’s in Information Systems. In addition, I've studied 1 semester in Computer Networks and Systems Engineering at ESTG (Polytechnic University of Viana do Castelo - Portugal).

### Technologies and Learning
- 🌱 *Currently learning:* Java, Node.js, Cybersecurity
- 🔭 *Improving:* Python, C++, MongoDB
- 💻 *Experience with:*  Python, Java, JavaScript, Node.js, C, C#, C++, PHP, HTML5, CSS, PostgreSQL, MySQL, MongoDB
...
- WP 3. EcoDispatch – Development of a New System for Shipment, Sequencing, and Ecological Transport
    ...
    └ Developed within the context of the DRIVOLUTION Mobilizing Agenda – Transition to the Factory of the Future

    └ [Public Notice](https://www.ipvc.pt/wp-content/uploads/2025/03/Edital_BII_01_2025_DRIVOLUTION-WP3-12-Bolsas_signed.pdf)
...
- Selected for an **International Student Mobility** program to Portugal (14/feb to 19/jul *2025*)
...
### Future Goals
I am interested in working with programming, whether in game development, software engineering, or cybersecurity. Additionally, after living in Portugal for a semester, my desire to live and work abroad increased. I still have a special dream of visiting Austria and Italia.
